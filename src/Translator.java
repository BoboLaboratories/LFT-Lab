...
public final class Translator {
     ...
     *               { expr2.op = NONE }
     *               <expr2>
     *               { emit(IF_ICMPGE, bexpr.falseLabel) }
     *
     * <bexpr> -> >  { expr1.op = NONE }
     *               <expr1>
     *               { expr2.op = NONE }
     *               <expr2>
     *               { emit(IF_CMPLE, bexpr.falseLabel) }
     *
     * <bexpr> -> <= { expr1.op = NONE }
     *               <expr1>
     *               { expr2.op = NONE }
     *               <expr2>
     *               { emit(IF_CMPGT, bexpr.falseLabel) }
     *
     * <bexpr> -> >= { expr1.op = NONE }
     *               <expr1>
     *               { expr2.op = NONE }
     *               <expr2>
     *               { emit(IF_CMPLT, bexpr.falseLabel) }
     *
     * <bexpr> -> == { expr1.op = NONE }
     *               <expr1>
     *               { expr2.op = NONE }
     *               <expr2>
     *               { emit(IF_CMPNE, bexpr.falseLabel) }
     *
     * <bexpr> -> <> { expr1.op = NONE }
     *               <expr1>
     *               { expr2.op = NONE }
     *               <expr2>
     *               { emit(IP_ICMPEQ, bexpr.falseLabel) }
     */
